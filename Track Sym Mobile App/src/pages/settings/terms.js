...
const data = [
  ...
  {
    title: strings.InformationCollectionAndUse,
    detail:
  ...
  {
    title: strings.ServiceProviders,
    detail:
  ...
  {
    title: strings.LinkToOtherSites,
    detail:
  ...
  {
    title: strings.ChangesToThisTermsAndConditions,
    detail:
