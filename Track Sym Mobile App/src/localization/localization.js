...
export let strings = new LocalizedStrings({
  "en-US": {
    ...
    Refresh: "Refresh",
    DailyStats: "Today’s COVID Cases",
    TotalStats: "All-Time COVID Cases",
    DailyStatsGraph: "Daily Cases",
    TotalStatsGraph: "All-Time COVID Cases",
    ...
    ChangesToThisTermsAndConditions: "Changes to This Terms and Conditions",
    ...
    UnableLoadingGraphDescription: "Unable to load graph description",
    ...
    DetailInfoAuthorFullName: "Wikipedia",
    ...
    PercentagePerMillion: "People Per Million",
    ...
    userReminderToCheck:
      ...
      SymptomAnalytics :"Symptom Analytics",
      Notification: "Notification",
      Hotlines: "Hotlines",
      
      Loading: "loading...",
      TotalSymptomReports:"Total Symptom Reports",
      SymptomReportsYesterday:"Symptom Reports Yesterday",
      SymptomReportsToCOVIDCases:"Symptom Reports to COVID Cases",
      MostReportedSymptom:"Most Reported Symptom",
      NoSymptomYet:"No Symptom Yet",
  ...
  am: {
    ...
    Done: "አለቀ",
    PleaseTryAgain: "እባኮ እንደገና ይሞክሩ!",
    YouHaveEnteredWrongUsernameOrPasswordPleaseTryAgain:
      "የተሳሳተ የተጠቃሚ ስም ወይም የይለፍ ቃል ሞልተዋል፤ እባኮ እንደገና ይሞክሩ!",
    SigninValidationText: "የተሳሳተ የተጠቃሚ ስም ወይም የይለፍ ቃል ሞልተዋል፤ እባኮ እንደገና ይሞክሩ!",
    Dismiss: "አጥፋ",
    UsernameAlreadyExists: "በዚህ ስም ለላ ተጠቃሚ አለ",
    PrivacyPolicyShortText: "አካውንት በመክፈት በ TrackSym ውል እና ግላዊነት ፖሊሲ እስማማለሁ",
    PassWordIsRequired: "የይለፍ ቃል ያስፈልጋል",
    PasswordDoesNotMatch: "የይለፍ ቃላቱ አይመሳሰሉም",
    PleaseEnterYourUsername: "እባኮ የተጠቃሚ ስምዎን ያስገቡ!",
    UsernameIsRequired: "የተጠቃሚ ስም ያስፈልጋል",
    PleaseEnterYourPassword: "እባኮ የይለፍ ቃሎን ያስገቡ!",
    PasswordDoNotMatch: "የይለፍ ቃላቱ አይመሳሰሉም",
    WrongCurrentPassword: "የወቅቱን የይለፍ ቃል ተሳስተዋል!",
    Required: "አስፈላጊ",
    CurrentPassword: "የወቅቱ የይለፍ ቃል",
    ConfirmNewPassword: "አዲሱን የይለፍ ቃል ያረጋግጡ",
    ConfirmNewPassword: "አዲሱን የይለፍ ቃል ያረጋግጡ",
    YouHaveSuccessfullyChangedYourPassword: "በተሳካ ሁኔታ የይለፍ ቃሎን ቀይረዋል",
    YouHaveSuccessfullyChangedYourProfile: "በተሳካ ሁኔታ የገፅ ምስሎን ቀይረዋል",
    Default: "መደበኛ",
    PasswordCanNotBeEmpty: "የይለፍ ቃል ባዶ መሆን አይችልም",
    Cancel: "ሰርዝ",
    Ok: "እሺ",
    ConnectionProblem: "የግንኙነት ችግር",
    CouldNotConnectToServer: "ከሰርቨር ጋር መገናኘት አልተቻለም",
    PleaseCheckYourConnection: "የበይነመረብ ግንኙነትዎን ይመልከቱ እና እንደገና ይሞክሩ!",
    AgreeingTermsAndServiceOnSignUp:
      "አካውንት በመክፈት በ TrackSym ውል እና ግላዊነት ፖሊሲ እስማማለሁ",
    CantConnectDueToConnection:
      "ውይ! ፤ የግንኙነት ችግር ያለብን ይመስላል ፤ እባክዎ እንደገና ይሞክሩ!",
    PleaseSelectGender: "እባኮ ፆታዎን ይምረጡ",
    PleaseSelectAgeGroup: "እባኮ የእድሜ ምድቦን ይምረጡ",
    LoadingGraphDescription: "ግራፊክ መግለጫን እየከፈተ ነው...",
    UnableLoadingGraphDescription: "Unable to load graph description",
    LoadingCriteriaDescription: "የመመዘኛዎች ዝርዝር መግለጫ እየከፈተ ነው",
    Languages: "ቋንቋዎች",
    English: "እንግሊዝኛ",
    Amharic: "አማርኛ",
    Oromiffa: "ኦሮምኛ",
    ...
    WhatIsCOVID19DetailInfoDescription: "ኮሮና ቫይረስ ዲዚዝ 2019",
    WhatIsCOVID19DetailInfoDescriptionContentOne:
    ...
    DetailInfoAuthorFullName: "ዊኪፔዲያ",
    InfoCovidDetailParagraphOneSubOne:
    ...
    InfoDetailMostCommonSyptomsListTitleFive: "ማአልጂያ",
    ...
    userReminderToCheck:
      "ሰላም 😻 ! የኔ ምልክቶች ገጽን ከጎበንኙ ቆይተዋል ፣ እባኮትን ይጎብኙ፡፡",   
    LastWeek: "ባለፈው ሳምንት",
    LastMonth: "ባለፈው ወር",
    ...
    SymptomAnalytics :"የምልክት ትንታኔዎች",
    Notification: "ማስታወቂያ",
    Hotlines: "ነጻ የስልክ መስመሮች",
  
    Loading: "በመጫን ላይ...",
    TotalSymptomReports:"አጠቃላይ የምልክት ሪፖርቶች",
    SymptomReportsYesterday:"የትናንት የምልክት ሪፖርቶች",
    SymptomReportsToCOVIDCases:"የኮቪድ ምልክት ሪፖርቶች",
    MostReportedSymptom:"በተደጋጋሚ ሪፖርት የተደረገው ምልክት",
    NoSymptomYet:"ምንም ምልክት የለም",
    EnterCountry:"ሀገር ያስገቡ",
    VIEW:"ይመልከቱ",
    NotificationDetail:"የማሳወቂያ ዝርዝር",
  ...
  tr: {
    ...
    SymptomAnalytics :"Semptom Analitiği",
    Notification: "Bildirim",
    Hotlines: "Yardım Hatları",
  
    Loading: "yükleniyor...",
    TotalSymptomReports:"Toplam Rapor Edilen Semptomlar",
    SymptomReportsYesterday:"Dünün Rapor Edilen Semptomlar",
    SymptomReportsToCOVIDCases:"KOVİD Vakalarında Rapor Edilen Semptomlar",
    MostReportedSymptom:"En Çok Rapor Edilen Semptom",
    NoSymptomYet:"Henüz Semptom Rapor Edilmemiş",
  ...
  orm: {
    ...
    NewConfirmed: "Haaraa-Qabaman",
    NewRecovered: "Haaraa-Dandamatan",
    NewDeath: "Haaraa-Du’an",
    TotalConfirmed: "Waliigalan-Qabaman",
    TotalRecovered: "Waliigalan-Dandamatan",
    TotalDeath: "Waliigalan-Du’an",
    ...
    RecommendedMethods: "MALOOTA DEGGARAMOO",
    RespiratoryHygiene: "Qulqullina Qaamolee Sirna Hargansuu",
    ...
    MajorConcern: "Xiyyeeffannaa Olaanaa",
    ...
    Conjunctivitis: "Gubuu fi diimachuu ijaa",
    ...
    Pneumonia: "Dhukkuba Sombaa",
    RepeatedShakingWithChills: "Hoollannaa fi Dhaamocha addaan hin cinne",
    ChangeProfile: "Eenyummeessa Jijjiiri",
    UpdateYourAgeGroup: "Gita umrii kee jijjiiri",
    UpdateYourGender: "Koorniyaa jijjiiri",
    NewPassword: "Jecha Darbi Haaraa",
    PrivacyPolicy: "Privacy Policy / Imaammata Dhuunfaa",
    InformationCollectionAndUse: "Haala funaansaafi fayyadama odeeffannoo",
    ServiceProviders: "Tajaajila Kan Kennan",
    LogData: "Kuufama Odeeffannoo",
    Security: "Nageenya",
    LinkToOtherSites: "Gara Marsariitii biroo deemuuf",
    ChildrensPrivacy: "Imaammata Dhuunfaa Ijoolleef",
    ChangesToThisPrivacyPolicy: "Jijjirama Imaammata Dhuunfaa irratti",
    TermsAndConditions: "Haalotaafi Waliigaltee",
    ChangesToThisTermsAndConditions: "Jijjiirama haalotaafi waliigaltee irrattii",
    ...
    PercentagePerMillion: "Istat. Hammamtaa Namoota Miilliyoonaan",
    References: "Wabii",
    ...
    userReminderToCheck:
      "Haarka Fuunee😻! Baaafata mallattoolee keessaan ilaaluu ni dandeessuu? Eerga ilaaltanii xiqqoo bubbuleera.",
    LastWeek: "Torbee Darbe",
    LastMonth: "Ji'a Darbe",
    LastThreeMonths: "Ji'oota Saddan Darban",
  
    SymptomAnalytics :"Xinxala Mallattoo",
    Notification: "Beeksisa",
    Hotlines: "Sarara Bilbilaa Bilisaa",
  
    Loading: "Fe'uurra...",
    TotalSymptomReports:"Gabaasoota Mallattoo Waligalaa",
    SymptomReportsYesterday:"Gabaasoota Mallattoo kalessaa",
    SymptomReportsToCOVIDCases:"Gabaasoota Mallattoo COVID",
    MostReportedSymptom:"Mallattoo Irra Caalaatti Gabaasame",
    NoSymptomYet:"Mallattoo Hin Jiruu",
    EnterCountry:"Biyya Galchi",
    VIEW:"Mul'isii",
    NotificationDetail:"Ibsama Beeksisaa",
