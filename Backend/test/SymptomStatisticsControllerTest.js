...
describe("Symptom Statistics API", function() {
    describe("Statistics Tests", function(){
        ...
        it("it should return total number of statics on /api/symptom_statistics GET", async () => {
        ...
        it("it should return total number of statics with the given filters on /api/symptom_statistics GET", async () => {
            let response = await chai
            .request(server)
            .get("/api/symptom_statistics")
    ...
    describe("Most Common Symptoms Tests API", function(){
        let user;
        let user_location;
        let symptom_user1;
        let symptom_user2;
