...
router.get("/api/symptomuser/symptom/:symptom_id", symptomuser_controller.get_symptomuser_by_symptom_id);
router.get("/api/symptomuser/user/:user_id",symptomuser_controller.get_symptomuser_by_user_id);
