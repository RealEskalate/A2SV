...
router.get("/api/medicalhistoryuser/:id", medicalhistory_user_controller.get_all_medicalhistory_user_by_id);
...
router.delete("/api/medicalhistoryuser", medicalhistory_user_controller.delete_medicalhistory_user_by_pair);
