...
location_user.index({ location: "2dsphere" });
demo_location_user.index({ location: "2dsphere" });
stress_location_user.index({ location: "2dsphere" });

const LocationUserModel = mongoose.model("LocationUser", location_user);
const DemoLocationUserModel = mongoose.model(
  "Demo LocationUser",
  demo_location_user
);
const StressLocationUserModel = mongoose.model(
  "Stress LocationUser",
  stress_location_user
);
